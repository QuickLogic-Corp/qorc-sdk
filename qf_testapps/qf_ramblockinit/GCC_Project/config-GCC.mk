...
export INCLUDE_DIRS=-I"$(PROJ_DIR)" \
                 ...
                 -I"$(PROJ_ROOT)/qf_testapps/$(PROJ_NAME)/fpga/rtl" \
				 -I"$(PROJ_ROOT)/qf_testapps/$(PROJ_NAME)/fpga/inc" \
...
export MAIN_FPGA_RTL_DIR	= $(PROJ_ROOT)$(DIR_SEP)qf_testapps$(DIR_SEP)$(PROJ_NAME)$(DIR_SEP)fpga$(DIR_SEP)rtl
export MAIN_FPGA_SRC_DIR	= $(PROJ_ROOT)$(DIR_SEP)qf_testapps$(DIR_SEP)$(PROJ_NAME)$(DIR_SEP)fpga$(DIR_SEP)src
