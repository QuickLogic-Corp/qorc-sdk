...
// Define the console serial port (used for CLI messages)
#define UART_ID_CONSOLE	UART_ID_HW      // the hard UART on the S3
// Define the debug serial port (used for dbg_XXX messages)
