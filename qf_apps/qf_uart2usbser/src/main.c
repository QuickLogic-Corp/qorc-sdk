...
extern signed portBASE_TYPE StartUARTtoUSBSerialConverterTask(
    void) ; // to remove warnings      uxPriority not used in the function

int main(void)
{

    SOFTWARE_VERSION_STR = "qorc-sdk/qf_apps/qf_uart2usbser";
    ...
    dbg_str("\n\n");
    dbg_str( "##########################\n");
    dbg_str( "Quicklogic QuickFeather UART to USB-Serial converter\n");
    dbg_str( "SW Version: ");
	...
	StartUARTtoUSBSerialConverterTask();
