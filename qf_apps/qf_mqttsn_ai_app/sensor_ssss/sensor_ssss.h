...
#if ((SENSOR_SSSS_BIT_DEPTH == 16) || (SENSOR_SSSS_BIT_DEPTH == 32))
/* */
#else
#error "Sensor bit-depth should be either 16-bits or 32-bits"
#endif
...
#define SENSOR_SSSS_MEMSIZE_MAX          ((SENSOR_SSSS_MAX_DATA_BLOCKS) * ((SENSOR_SSSS_SAMPLES_PER_BLOCK)+32))
...
extern sensor_ssss_config_t sensor_ssss_config;
