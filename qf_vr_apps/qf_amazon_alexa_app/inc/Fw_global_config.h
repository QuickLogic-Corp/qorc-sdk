...
//#define QL_AUDIO_PREPROC_ALGO (21) //QL_AUDIO_PREPROC_DSPC_NS_1MIC
#define QL_AUDIO_PREPROC_ALGO (22) //QL_AUDIO_PREPROC_DSPC_NS_2MIC

#if (DSPC_AW == 1)
//#define DSPC_SCHEMATIC   (9) //9 is 1 mic
#define DSPC_SCHEMATIC   (1) //1 is 2 mic beamforming
#define ENABLE_AW_TUNING (0)
#endif
...
#define MAX_STACK_MONITOR_COUNT   (100) // 100 = 100 sec
