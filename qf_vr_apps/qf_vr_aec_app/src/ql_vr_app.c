...
#if (FEATURE_MULTI_CHANNEL_STREAM_DEVICE == 1)
    .hold_count = 40,  // we do not need much in the circular buffer
#else
...
/* AEC  */  { AUDIO_ISR_PID,          AUDIO_QL_PRE_PROC_PID,     true, true,  true,  &audio_ql_pre_proc_outq_processor, &ql_pre_proc_funcs,     NULL,   &ql_pre_proc_sem },
