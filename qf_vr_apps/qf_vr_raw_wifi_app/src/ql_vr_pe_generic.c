...
extern void addto_2channel_queue(int16_t *ch1_data, int16_t *ch2_data, int data_size);
#else
extern void addto_3channel_queue(int16_t *ch1_data, int16_t *ch2_data, int16_t *ch3_data, int data_size);
#endif
#endif
int ww_detected = 0;
int ww_size = 0;
...
#if (FEATURE_MULTI_CHANNEL_STREAM_DEVICE == 1)
#if (NUM_AUDIO_STREAM_CHANNELS == 2)
         //for Test repeat channel 2 data same as channel 1 data
         addto_2channel_queue((short*)&a_audio_brick[0],(short*)&a_audio_brick[0], vr_engine_samples_per_frame);
#else
         //for Test repeat channel 2,3 data same as channel 1 data
         addto_3channel_queue((short*)&a_audio_brick[0],(short*)&a_audio_brick[0], (short*)&a_audio_brick[0], vr_engine_samples_per_frame);
#endif
#endif
