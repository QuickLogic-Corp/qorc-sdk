...
/** @file fpga_loader.c
 *  @brief FPGA Loader API Implementation
 *
 *  This file contains the implementation of the FPGA
 *  Loader API.
 *
...
/**
 * @brief Initializes the FPGA RAM Blocks with the content specified
 * 
 * The FPGA RAM Blocks Initialization Array, generated from the FPGA tooling
 * is used in this function to initialize the memory cells.
 * This should be called after the FPGA Configuration is done, and we have
 * exited the FPGA Configuration Control mode.
 * 
